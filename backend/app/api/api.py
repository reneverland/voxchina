...
from app.api.v1.endpoints import articles, vox_workshop, search, trending, voices, auth, llm_config, script_generation, academic_extract, knowledge, integrated_voiceover, image_manager, hot_news, email
...
api_router.include_router(image_manager.router, prefix="/images", tags=["images"])
